      ...
      <div>
        ...
        <div className="card">
          <div className="card-header">
            <div className="card-title">{isPending ? 'Application Pending Approval' : 'Concession Active'}</div>
          </div>
          <div style={{ padding: '1rem 0' }}>
            <p style={{ marginBottom: '1rem' }}>
              {isPending
                ? 'You already have a concession application pending approval. You cannot apply for another until it is resolved.'
                : `Your current concession is active for ${existingConcession.daysLeft} more day${existingConcession.daysLeft===1?'':'s'}. You can apply for a renewal within 3 days of expiry.`
              }
            </p>
